function main_action(){
    ...
    const content_itself = document.getElementById('content_itself');
    const spinner_container = document.getElementById('spinner_container');
    const active_links = document.querySelectorAll('.active_link');

    active_links.forEach((element) => {
        element.addEventListener('click',(event)=>{
            event.target.classList.add('disabled');
            content_itself.classList.add('invisible');
