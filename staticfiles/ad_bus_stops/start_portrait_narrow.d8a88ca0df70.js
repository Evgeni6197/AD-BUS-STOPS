...
function animation_frame(){
    ...
    if (count < 100){
        ...
        pic_containers[1].style.left = `${pic_container2X - deltaX * (count - 500)}px`;
        count ++;     
    } else if( count === 530 ){ 
        ...
        pic_containers[4].style.top = `${pic_containerY_top}px`;
        ...
        // smooth x-coordinate shift 
        pic_containers[3].style.left = `${pic_container2X - deltaX * (count - 731)}px`;
        count ++;     
    } else if( count === 761 ){ 
        ...
        pic_containers[5].style.top = `${pic_containerY_bottom}px`;
        ...
        // smooth x-coordinate shift 
        pic_containers[4].style.left = `${pic_container2X - deltaX * (count - 962)}px`;
        count ++;     
    } else if( count === 992 ){ 

        // setting initial absolute x-coordinates to finish smooth shifting accurately
        pic_containers[4].style.left = `${pic_container1X}px`;
        pic_containers[6].style.left = `${pic_container2X}px`;
        pic_containers[6].style.top = `${pic_containerY_top}px`;
        ...
        // smooth x-coordinate shift 
        pic_containers[5].style.left = `${pic_container2X - deltaX * (count - 1193)}px`;
        count ++;     
    } else if( count === 1223 ){ 

        // setting initial absolute x-coordinates to finish smooth shifting accurately
        pic_containers[5].style.left = `${pic_container1X}px`;
        pic_containers[7].style.left = `${pic_container2X}px`;
        pic_containers[7].style.top = `${pic_containerY_bottom}px`;
        pic_containers[7].classList.remove('invisible');
        count ++;         
