document.addEventListener('DOMContentLoaded', ()=>{
    ...
    book_buttons.forEach((element)=>{
        ...
        element.addEventListener('click',(event)=>{
            ...
            if (order_id){
                ...
                months_to_book = '';
                fetch_put(stop_id, months_to_book , price, order_id);
            } else {
    ...
    function fetch_put(stop_id, months_to_book , price, order_id){
