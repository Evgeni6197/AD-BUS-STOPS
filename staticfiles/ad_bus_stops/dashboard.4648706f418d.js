document.addEventListener("DOMContentLoaded", ()=>{
    ...
    const cancel_order_link = document.getElementById('cancel_order_link');
    const form_container = document.getElementById('form_container');
    const form_sbm_btn = document.getElementById('form_sbm_btn');
    ...
    // cancel order prosessing
    cancel_order_link.addEventListener('click',(event)=>{
        event.preventDefault();
        form_container.classList.remove('invisible');
    });

    form_sbm_btn.addEventListener('click',(event)=>{
        form_sbm_btn.disabled = true;
        event.target.parentNode.submit();
    });
