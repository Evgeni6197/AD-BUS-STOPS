            ...
            .then(result => {
                ...
                if (!result.db_successful_connections){
                    ...
                    if (result.successful_cart_addition){
                        ...
                        console.log('quantity_in_cart_1 =',quantity_in_cart);
                    ...
                    // cart addition failed
                        ...
                        console.log('quantity_in_cart_2 =',quantity_in_cart);
                        ...
                        // any other booking rejection reason    
                        } else {
                            current_book_button.addEventListener('click', book_button_click)
                        }
            ...
            .then(result => {
                ...
                if (!result.db_successful_connections){
                    ...
                    if (result.order_created){
                        console.log('quantity_in_cart_3 =',quantity_in_cart);
                    ...
                    // booking faluire    
                        ...
                        console.log('quantity_in_cart_4 =',quantity_in_cart);
                        actual_price = result.actual_price;
                        ...
                        document.getElementById('priceSpan_'+ stop_id).innerHTML = actual_price;
                        update_vacant_from_prompt(vacant_from, stop_id  );                        
                        return_button.click();
                        show_message(try_again_text); 
                    }
                }
